...
- Reactive source: user input through browser interaction

--

- Reactive endpoint: resulting plot or table that appears in the app

--

- Reactive conductor: connects sources and endpoints together.
